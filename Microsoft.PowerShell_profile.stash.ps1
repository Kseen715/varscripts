...
# REQUIRES:
# - choco
# - oh-my-posh (from choco)

# Run `$profile` in PS to get place where you need to put this
...
# Set-PSReadLineKeyHandler -Chord 'Ctrl+d,Ctrl+c' -Function CaptureScreen # do not work in PS7
Set-PSReadLineKeyHandler -Key Alt+d -Function ShellKillWord
Set-PSReadLineKeyHandler -Key Alt+Backspace -Function ShellBackwardKillWord
# Set-PSReadLineKeyHandler -Key Alt+b -Function ShellBackwardWord # do not work in PS7
# Set-PSReadLineKeyHandler -Key Alt+f -Function ShellForwardWord # do not work in PS7
# Set-PSReadLineKeyHandler -Key Alt+B -Function SelectShellBackwardWord # do not work in PS7
# Set-PSReadLineKeyHandler -Key Alt+F -Function SelectShellForwardWord # do not work in PS7
